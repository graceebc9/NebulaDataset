...
from src.postcode_utils import find_data_pc_joint
...
def get_ratio(proc, epc):
    ...
    return df[['gross_epc', 'premise_age_bucketed','TOTAL_FLOOR_AREA', 'PROPERTY_TYPE', 'meta_res', 'uprn','gross_area' , 'total_fl_area_meta', 'total_fl_area_meta_source', 'epc_form', 'BUILT_FORM', 'TENURE', 'CONSTRUCTION_AGE_BAND', 'premise_age','premise_type', 'PROPERTY_TYPE']]
